...
async function initializeStore13() {
  ...
  try {
    ...
    `, [companyMap['زين اثير'], categoryId, [svg1, svg2, svg3, svg1, svg2], [svg3, svg1, svg2, svg3, svg1], [svg2, svg3, svg1, svg2, svg3]]);
    ...
    const products2 = await pool.query(`
      ...
      RETURNING id, amount, price, array_length(images, 1) as images_count
    `, [companyMap['آسيا سيل'], categoryId, [svg1, svg2, svg3, svg1], [svg2, svg3, svg1], [svg3, svg1, svg2]]);
    ...
    const products3 = await pool.query(`
      ...
      RETURNING id, amount, price, array_length(images, 1) as images_count
    `, [companyMap['كورك'], categoryId, [svg1, svg2], [svg2, svg3, svg1, svg2, svg3], [svg3, svg1]]);
